...
class LddTelemetry:
    ...
    def load_from_packet(packet: bytes) -> LddTelemetry:
        ...
        hv1 = LDD_VOLT_UNIT * ldd[0]
        ldout1 = LDD_VOLT_UNIT * ldd[1]
        lt1 = LDD_TEMP_UNIT * ldd[2] - 273
        lt2 = LDD_TEMP_UNIT * ldd[3] - 273
        lt3 = LDD_TEMP_UNIT * ldd[4] - 273
        rt1 = LDD_TEMP_UNIT * ldd[5] - 273 + RT1_ADD_LIST[channel]
        rt2 = LDD_TEMP_UNIT * ldd[6] - 273 + RT2_ADD_LIST[channel]
        rt3 = LDD_TEMP_UNIT * ldd[7] - 273 + RT3_ADD_LIST[channel]
